...
#ifdef CONFIG_ENABLE_AX88179_178A_PTP_FUNC
#include "ax_ptp.h"
#endif

#ifdef CONFIG_ENABLE_AX88179_178A_AUTODETACH_FUNC
...
#ifdef CONFIG_ENABLE_AX88179_178A_AX88279
	//printk("============AX88279==========");
...
static const char ax_gstrings[][ETH_GSTRING_LEN] = {
	...
	"bulkint_complete",
	"bulkint_error",
#ifdef CONFIG_ENABLE_AX88179_178A_QUEUE_PRIORITY
	"ep5_count",
	"ep3_count",
#endif
};
...
#ifdef CONFIG_ENABLE_AX88179_178A_RX_TASKLET
...
#ifdef CONFIG_ENABLE_AX88179_178A_TX_TASKLET
...
#ifndef CONFIG_ENABLE_AX88179_178A_INT_POLLING
...
#ifdef CONFIG_ENABLE_AX88179_178A_INT_POLLING
...
#ifndef CONFIG_ENABLE_AX88179_178A_RX_TASKLET
...
#ifndef CONFIG_ENABLE_AX88179_178A_TX_TASKLET
...
{
#ifdef CONFIG_ENABLE_AX88179_178A_MAC_PASS
	...
	if (macpass.control == MAC_PASS_CONFIG_ENABLE_AX88179_178A_0)
		memcpy(mac, macpass.mac0, 6);
	else if (macpass.control == MAC_PASS_CONFIG_ENABLE_AX88179_178A_1)
